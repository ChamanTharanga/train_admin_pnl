						...
						<div className="d-flex justify-content-between align-items-center">
							<div className="header-action">
								...
								<ol className="breadcrumb page-breadcrumb">
									<li className="breadcrumb-item"><span>Train booking App</span></li>
									<li className="breadcrumb-item"><span></span></li>
							...
							<div className="col-6 col-md-4 col-xl-2">
								<div className="card">
									<div className="card-body ribbon">
										...
										<Link to="/schedule" className="my_sort_cut text-muted">
									...
									<div className="col-xl-12">
										<div className={`card ${isCardRemove ? 'card-remove' : ''} ${isFullScreen ? 'card-fullscreen' : ''} ${isCollapsed ? 'card-collapsed' : ''}`}>
											<div className="card-header">
												<h3 className="card-title">Booking Report</h3>
